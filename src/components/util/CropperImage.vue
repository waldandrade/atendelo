<template>
  <v-card ref="card">
    <v-card-text class="pa-0">
      <vue-cropper alt="User image" id="image" ref="cropper" :src="getSrc"
      ...
      :minContainerHeight="cropperOptions.minContainerHeight"></vue-cropper>
    </v-card-text>
    <v-divider></v-divider>
    <v-card-actions>
      <v-btn color="accent" flat @click="cropped" >Finalizar</v-btn>
    </v-card-actions>
  </v-card>
</template>
